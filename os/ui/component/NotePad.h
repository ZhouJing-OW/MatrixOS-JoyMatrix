...
//             }
//             else if (inScale == 1)
//               MatrixOS::LED::SetColor(globalPos, color.Blink_Key(Device::KeyPad::fnState)); 
//             else if (inScale == 2)
//               MatrixOS::LED::SetColor(globalPos, rootColor.Blink_Key(Device::KeyPad::fnState));
//           }
//           index++;
//         }
//       }
...
//           MatrixOS::Component::Pad_Setting(config, NOTE_PAD);
//           GenerateKeymap();
//           return true;
//         }
